...
public class ResponseWrap {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ResponseWrap.class);
    ...
    public ResponseWrap(HttpRequestBase request, HttpResponse response, HttpClientContext context, ObjectMapper mapper){
